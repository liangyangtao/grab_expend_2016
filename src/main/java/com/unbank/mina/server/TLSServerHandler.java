...
public class TLSServerHandler extends IoHandlerAdapter {
	...
	public void sessionClosed(IoSession session) throws Exception {
		...
		broadcast("The user " + remoteAddress + " has left the chat session.");
	}
	...
	public void messageReceived(IoSession session, Object message) {
		...
		if (message instanceof Integer) {
			...
			if (temp.equals(Constants.constants.HEARTBEATREQUEST)
					|| temp.equals(Constants.constants.HEARTBEATRESPONSE)) {
