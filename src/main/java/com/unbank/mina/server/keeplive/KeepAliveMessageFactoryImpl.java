...
public class KeepAliveMessageFactoryImpl implements KeepAliveMessageFactory {
	...
	public boolean isRequest(IoSession arg0, Object arg1) {
		...
		if (arg1 instanceof String) {
			...
			return temp.equals(Constants.constants.HEARTBEATREQUEST);
		}
	...
	public boolean isResponse(IoSession arg0, Object message) {
		...
		if (message instanceof String) {
			...
			return temp.equals(Constants.constants.HEARTBEATRESPONSE);
		}
		return false;
	}
}
